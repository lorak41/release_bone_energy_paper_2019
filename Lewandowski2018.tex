...
\begin{equation}
\int_{\partial \Gamma } \gamma \mathbf A_{\partial \Gamma} \cdot {\dot {\boldsymbol {\rm W} } } \mathrm d L -\int_{\partial \Gamma} {\dot {\boldsymbol {\rm W} } } \cdot \lim_{|\mathcal L_{\rm n}| \to 0 }  \int_{\mathcal L_{\rm n} } {\bm {\Sigma}}\mathbf{N} \mathrm d S  = 0
\end{equation}
...
\begin{equation}
\mathbf G = \lim_{|\mathcal{ L }|\to 0} \int_{ {{\mathcal L}_{\rm n}} } {\bm {\Sigma}}\mathbf{N}\, \mathrm d L 
\label{eq:crack_configuration_force}
\end{equation}
It should be noted that for a continuous and homogeneous elastic body, the configurational force $\mathbf G$ away from the crack should be zero.
...
\textcolor{red}{This section will be corrected and reduced by Lukasz.} \\
...
\end{equation}
The nodal configurational forces $\mathbf{\tilde G}^h$ are the driving force for the crack front propagation and have the following form:
\textcolor{red}{Lukasz, please check this equation.} \\
