...
Finally, this framework was applied to investigate performance of the model for non-idealised case of crack propagation within an equine 3rd metacarpal with varying material properties obtained from CT scan.
It was found that the model performs well for challenging body shape and material properties input.   
