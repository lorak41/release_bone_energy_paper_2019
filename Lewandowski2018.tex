...
\begin{figure}
	...
	\caption{The resulting density distribution from the bone adaptation analysis is approximated directly onto integration points of the mesh used for fracture analysis using MWLS method described earlier in~\ref{sec:mwls}. The cutting circular plane used to create an initial crack is also shown.}
...
OPTIONAL RESULTS, SHOULD WE INCLUDE THEM?
