...
This paper extends the authors' previous work on modelling fracture propagation \cite{kaczmarczyk2014three,kaczmarczyk2017energy} to incorporate the influence of spatially varying material properties. Furthermore, it combines this with ct scan data crack propagation in bone examples. Although this work is generic in nature and applicable to both human and animal bone, this paper focuses the numerical examples on equine bone. 
