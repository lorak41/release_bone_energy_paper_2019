...
\textcolor{red}{In Kuhl and Steinmann $\mathcal{R}_0$ it is called locally created mass but isn't it more accurate as locally produces density rate?}
...
\begin{figure}[h!]
	\begin{centering}
		...
		\caption{Bell function plotted for different values of the integer exponent $b$. As $b \rightarrow \infty$, bell-shape curve becomes infinitely steep at $ \rho{^\mathrm{min}}$ and $ \rho{^\mathrm{max}}$ sharpen.}
		\label{fig:bell_func}
	\end{centering}
\end{figure}
