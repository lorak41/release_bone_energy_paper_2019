...
As previously demonstrated (in Figure~\ref{fig:plate_conv_singularity}) modelling singularity can significantly improve the accuracy of the configurational forces at the crack front. However, multiple tests have shown that accurate stress state at the tip has a negligible impact on the full crack propagation analysis. 
